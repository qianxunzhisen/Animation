package com.wuqiqi.animation.mvp.ui.dialog;
...
public class ProgressDialog {
    ...
    public void show(Context mContext) {
        if(materialDialog!=null){
            materialDialog = new MaterialDialog(mContext,MaterialDialog.getDEFAULT_BEHAVIOR());
            materialDialog.cancelable(false).show();
        }
        materialDialog.show();
